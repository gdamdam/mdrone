...
39 authored visualizers organised into four **function-based** groups in the picker. Within each group, **B&W / monochromatic** visualizers are listed first, then **colour**:
...
- **LANDSCAPE** — slow accreting fields: rock carvings, textile, strata, dust, tape. petroglyphs, illuminated glyphs, mirror glyphs, aurora, sediment strata, spectral prayer rug, granular weather, tape decay, ink bloom.
- **RITUAL** — ornate / painterly / ceremonial. iron filings, cymatics, sigil bloom, crystal lattice, breathing mandala, halo & rays, Julia fractal, halftone, scrying mirror, Rothko field.
- **VOID · HYPNOTIC** — minimal negative space or stroboscopic / psychotropic. void monolith, moiré field, feedback tunnel B&W, shortwave static, flow field, feedback tunnel, star gate, dream machine *(10 Hz flicker — warning shown; close eyes for the classic usage)*.
