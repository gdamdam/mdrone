...
export const PRESETS: Preset[] = [
  {
    ...
    hint: "Lone tanpura with jawari buzz — rooted, overtone-rich, almost dry. An Indian string-drone feel.",
    voiceLayers: ["tanpura"],
  ...
  },
  {
    ...
    hint: "Harmonium / shruti-box sustain — warm, woody, devotional. Slow breath modulation and a wooden room.",
    tuningId: "just5", relationId: "tonic-fifth",
    voiceLayers: ["reed"],
    voiceLevels: { reed: 1 },
    reedShape: "balanced",
  ...
  },
  {
    ...
    hint: "Pipe-organ reed in meantone with slow chord morphs — architectural and glacial. In the Kali Malone choral-organ lineage.",
  ...
  },
  {
    ...
    hint: "Pure sines in 5-limit just intonation, no coloration. The beating between tones carries the piece — in the Dream House lineage.",
  ...
  },
  {
    ...
    hint: "Reed and air through a long cistern tail — a single breath fills the whole space. Inspired by Pauline Oliveros's cistern recordings.",
  ...
  },
  {
    ...
    hint: "Subterranean organ mass — low pipes, stone pressure, almost no motion. Darker and heavier than Kali Organ; the nave felt as weight rather than space.",
    tuningId: "meantone", relationId: "drone-triad",
    voiceLayers: ["reed"],
    voiceLevels: { reed: 1 },
    reedShape: "balanced",
  ...
  },
  {
    ...
    hint: "Bowed-string reed + air sustained as a minor triad with slow ~25 s swells. Warm tape-and-room body — in the Stars of the Lid lineage.",
  ...
  },
  {
    ...
    hint: "Cassette-dubbed bowed strings through heavy wow flutter and tape hiss. Darker and more eroded than Nitrous Oxide — funereal, slow, dissolving.",
    tuningId: "just5", relationId: "minor-triad",
    voiceLayers: ["reed", "air"],
  ...
  },
  {
    ...
    hint: "Tanpura plucks anchoring a shruti-box reed organ, just intonation on tonic + fifth. The sound of a practice room before the raga begins.",
    tuningId: "just5", relationId: "tonic-fifth",
  ...
  },
  {
    ...
    hint: "Bright tanpura strings with a metallic sympathetic-string halo — jawari buzz plus upper-harmonic sparkle. The resonant glow of a sitar left ringing.",
    tuningId: "just5", relationId: "tonic-fifth",
  ...
  },
  {
    ...
    hint: "Single sine tone with a close, uncoloured room. Drift is microscopic — in the Éliane Radigue / ARP lineage.",
  ...
  },
  {
    ...
    hint: "Sparse piano intervals over an even-partial reed pad in 5-limit just intonation. Bright and spacious with silence between the tones — in the Eno tape-pad lineage.",
    tuningId: "just5", relationId: "drone-triad",
  ...
  },
  {
    ...
    hint: "Deep reed fundamental with an inharmonic metal halo above. The overtone shimmer of Gyuto-style throat singing.",
    tuningId: "equal", relationId: "unison",
  ...
  },
  {
    ...
    hint: "Metal-bowl modes over a low sine reed — rim-friction tone plus the inharmonic cloud above. Circular and resonant, not a bright bell.",
  ...
  },
  {
    ...
    hint: "Low single-note drone from detuned analog-style oscillators — odd-partial reed with cabinet body, tape and subtle wow. Hypnotic, narcotic, ceremonial. In the Coil Time Machines lineage.",
    tuningId: "equal", relationId: "unison",
  ...
  // ─── FM showcase: Glass Bell — high-ratio FM bell drone ─────────────
  {
    ...
    hint: "Dense inharmonic bell sidebands from high-index FM. Breathes slowly — sidebands bloom and recede over tens of seconds. Metallic, bright, crystalline.",
  ...
  // ─── FM showcase: Gong Meditation — low-ratio FM gong drone ────────
  {
    ...
    hint: "Low-ratio FM producing deep gong-like tones, layered with metal-bowl partials for a bronze ensemble character. Long hall for temple space.",
...

  {
    ...
    hint: "Pure spectral texture — air and metal drifting through comb, tape and hall. No identifiable pitched sources — in the Nurse With Wound ambient lineage.",
    tuningId: "equal", relationId: "unison",
  ...
  },
  {
    ...
    hint: "Distorted amp sustain with a reed body and a metallic feedback halo, swelling in slow breaths. Drone-metal pressure — in the Sunn O))) / Earth lineage.",
  ...
  },
  {
    ...
    hint: "Dense air texture with inharmonic metal crackle — spectral weather with tape wear and comb glare. In the Merzbow ambient-side vein.",
    tuningId: "equal", relationId: "unison",
    voiceLayers: ["air", "metal"],
  ...
  },
  {
    ...
    hint: "Wind-field air over a soft reed rumble. Comb and wow give it a frozen howl, tape a worn edge — in the Thomas Köner deep-cold lineage.",
  ...
  // ─── Klaus Wiese — ritual bowl + tanpura cloud ──────────────────────
  {
    ...
    hint: "Tanpura + metal-bowl cloud in a long hall — layered bowls beating against a tanpura drone. Extreme stillness — inspired by Klaus Wiese.",
    tuningId: "harmonics", relationId: "harmonic-stack",
  ...
  // ─── Tim Hecker — Ravedeath: distorted granular organ ───────────────
  {
    ...
    hint: "Pipe-organ reed through amp distortion into hall, with a granular stutter on top. Church organ distorted until it breaks — in the Tim Hecker lineage.",
  ...
  // ─── Andrew Liles — dark tape-warped drone (industrial facet) ───────
  {
    ...
    hint: "Tonal but deeply tape-warped — reed + metal + air with heavy wow and granular cloud. Occasional chromatic drift gives it the Liles 'something is wrong' feel. In the Andrew Liles tape-work lineage.",
    tuningId: "just5", relationId: "tonic-fifth",
  ...
  // ─── Fennesz — processed granular harmonic stack ────────────────────
  {
    ...
    hint: "Guitar-like reed with an air halo, long bloom through tape and graincloud. Continuous warm melodic smear under a grain shimmer — in the Fennesz Endless Summer lineage.",
  ...
  // ─── William Basinski — Disintegration Loops ────────────────────────
  {
    ...
    hint: "Reed with amp hum as the loop source; tape, wow and graincloud as the crumbling medium around it. Dry and close-miked — in the Basinski Disintegration Loops lineage.",
    tuningId: "equal", relationId: "drone-triad",
    voiceLayers: ["reed", "amp"],
  ...
  // ─── Grouper — Dragging a Dead Deer Up a Hill ───────────────────────
  {
    ...
    hint: "Lo-fi piano under a veil of air, tape and plate patina. In the Grouper lineage.",
    tuningId: "equal", relationId: "tonic-fifth",
  ...
  // ─── Marconi Union — clean modern ambient with slow descent ─────────
  {
    ...
    hint: "Clean high pads with sparse piano pings and a gentle falling bass. Wide, slow and modern rather than nostalgic — spacious enough to float, deliberate enough not to blur.",
    tuningId: "just5", relationId: "drone-triad",
  ...
  // ─── Andrew Liles — cinematic facet, quieter and more tonal ─────────
  {
    ...
    hint: "Tonal, slow, tape-treated — bowed-string reed, air and a thread of piano with a deep-chamber cistern. The quieter Liles, without the chromatic drift.",
    tuningId: "just5", relationId: "drone-triad",
  ...
  // ─── Ellen Arkbro — meantone chord drones ───────────────────────────
  {
    ...
    hint: "Austere meantone chords with a pale brass-air edge. Drier and more vertical than Kali Organ — stone, breath and chordal suspension in a church.",
    tuningId: "meantone", relationId: "drone-triad",
    voiceLayers: ["reed", "air"],
  ...
  // ─── Catherine Lamb — microtonal chamber ────────────────────────────
  {
    ...
    hint: "Pure sines in harmonic-series tuning — combination tones emerge from the beating between closely-spaced fundamentals. Dry, focused, spectral. In the Catherine Lamb lineage.",
    tuningId: "harmonics", relationId: "harmonic-stack",
    voiceLayers: ["reed"],
    voiceLevels: { reed: 1 },
    reedShape: "sine",
  ...
  },
  {
    ...
    hint: "Bronze gong sustain layered with a saron-like reed in slendro pentatonic. Pitched saron character with an inharmonic gong halo above.",
  ...
  },
  {
    ...
    hint: "Held oud-like reed against a tonic drone in maqam rast with a faint breath bed. The microtonal half-flat third sits between major and minor — distinctly Arabic.",
    voiceLayers: ["reed", "air"],
  ...
  },
  {
    ...
    hint: "The vocal/devotional side of maqam rast — richer organ-like reed, breath, formant for vocal resonance. More human and choral than the Oud preset.",
    voiceLayers: ["reed", "air"],
    voiceLevels: { reed: 1, air: 0.3 },
    reedShape: "balanced",
    octaveRange: [2, 3],
  ...
  // ─── Charlemagne Palestine — overtone piano strumming ──────────────
  {
    ...
    hint: "Sustained piano at high bloom with shimmer feeding overtones back. The piano acts as an overtone generator — in the Charlemagne Palestine strumming-technique lineage.",
    tuningId: "harmonics", relationId: "harmonic-stack",
    voiceLayers: ["piano", "reed"],
  ...
  // ─── Pauline Oliveros — accordion drone ────────────────────────────
  {
    ...
    hint: "Close-miked accordion — fast breath, little room, no halo. Odd-harmonic reed tone with the feel of bellows moving air in front of you.",
    tuningId: "just5", relationId: "unison",
    voiceLayers: ["reed", "air"],
    voiceLevels: { reed: 1, air: 0.18 },
    reedShape: "odd",
  ...
  // ─── Eleh — pure electronic sub-heavy drone ────────────────────────
  {
    ...
    hint: "Pure electronic drone — FM and sine reed, sub-heavy, minimal FX. No instrument imitation; harmonic stacking, low weight, slow spectral movement. In the Eleh lineage.",
    tuningId: "equal", relationId: "unison",
    voiceLayers: ["fm", "reed"],
  ...
  // ─── Phill Niblock — dense microtone wall ──────────────────────────
  {
    ...
    hint: "Wall of close-tuned instruments in a drone-triad. The only motion is the beating between near-unison partials — everything else stays still. In the Phill Niblock lineage.",
    tuningId: "just5", relationId: "drone-triad",
    voiceLayers: ["reed", "air"],
  ...
  },
  {
    ...
    hint: "Low fundamental driven by continuous breath cycles through a vocal-tract formant stack. Air for body, odd-partial reed for overtones, sub for the thump. Deep, bodily, continuous.",
    tuningId: "equal", relationId: "unison",
    voiceLayers: ["air", "reed"],
  ...
  },
  {
    ...
    name: "Clinical Sines",
    attribution: "Clinical digital minimalism · pure sines",
    hint: "Absolutely pure sines in harmonic-stack intervals — dry, no drift, no modulation. Digital clarity only, no warmth. In the Alva Noto / Ryoji Ikeda lineage.",
  ...
  },
  {
    ...
    hint: "Amp-cabinet body + odd-harmonic reed chord + metallic halo held in a minor triad through cathedral reverb. Massive sub, long sustain, cranked tape. In the Sunn O))) / Boris lineage.",
    tuningId: "equal", relationId: "minor-triad",
    voiceLayers: ["amp", "reed", "metal"],
  ...
  },
  {
    ...
    hint: "Balanced reed fundamental with a high metal-whistle partial emerging above. Brighter and more melodic than Tibetan chant — a Tuvan khöömei feel.",
    tuningId: "equal", relationId: "tonic-fifth",
    voiceLayers: ["reed", "metal", "air"],
  ...
  },
  {
    ...
    hint: "Bowed-string drone against a tanpura tonic with a comb-resonant sympathetic halo. Vocal-like portamento, maqam-rast microtuning — a sarangi feel. Warmer and more articulate than sitar-sympathy.",
    tuningId: "maqam-rast", relationId: "drone-triad",
