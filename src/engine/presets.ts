...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    hint: "Bronze gong-and-saron drone in the slendro pentatonic. Hollow metallic sustain with slow bloom and a long hall — the suspended hum of a Javanese court ensemble between strikes.",
    voiceLayers: ["metal"],
    voiceLevels: { metal: 1 },
    octaveRange: [2, 3],
    drift: 0.22,
  ...
  },
  {
    ...
    effects: ["plate"],
    scale: "drone",
    tuningId: "slendro", relationId: "tonic-fifth",
    gain: 1.0,
    motionProfile: motionProfile({
  ...
  },
  {
    ...
    name: "Maqam Rast (Oud)",
    attribution: "Arabic devotional · oud + drone",
    hint: "A held oud-like reed sustained against a tonic drone in maqam rast. The microtonal half-flat third sits between major and minor — distinctly Arabic, neither western mode. Plate room and a slow bloom.",
    voiceLayers: ["reed"],
    voiceLevels: { reed: 1 },
    reedShape: "odd",
    octaveRange: [2, 3],
