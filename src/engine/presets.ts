...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    hint: "Meantone pipe-organ reed, slow chord morphs. Architectural, glacial, no bell. Kali-Malone-like.",
  ...
  },
  {
    ...
    hint: "Single sine tone in a close, uncoloured room. Microscopic drift only. Radigue-like.",
  ...
  },
  {
    ...
    hint: "Sparse piano over a soft reed pad in 5-limit tuning. Bright, spacious, Eno-like.",
    tuningId: "just5", relationId: "drone-triad",
  ...
  },
  {
    ...
    hint: "Detuned analog-style drone, cabinet body, tape warmth. Hypnotic, narcotic, Coil-like.",
    tuningId: "equal", relationId: "unison",
  ...
  },
  {
    ...
    hint: "Wind-field air over a soft reed rumble. Frozen howl, worn tape edge. Köner-cold.",
  ...
  // ─── Andrew Liles — dark tape-warped drone (industrial facet) ───────
  {
    ...
    hint: "Tape-warped reed, metal and air with heavy wow and granular cloud. Tonal but unheimlich. Liles-like.",
    tuningId: "just5", relationId: "tonic-fifth",
  ...
  // ─── Grouper — Dragging a Dead Deer Up a Hill ───────────────────────
  {
    ...
    hint: "Lo-fi piano under a veil of air, tape and plate patina. Grouper-like.",
    tuningId: "equal", relationId: "tonic-fifth",
  ...
  // ─── Charlemagne Palestine — overtone piano strumming ──────────────
  {
    ...
    hint: "Sustained piano at high bloom, shimmer feeding overtones back. Palestine-style overtone generator.",
    tuningId: "harmonics", relationId: "harmonic-stack",
    voiceLayers: ["piano", "reed"],
  ...
  // ─── Phill Niblock — dense microtone wall ──────────────────────────
  {
    ...
    hint: "Wall of close-tuned instruments in a drone-triad. Motion only in beating near-unison partials.",
    tuningId: "just5", relationId: "drone-triad",
    voiceLayers: ["reed", "air"],
  ...
  },
  {
    ...
    hint: "Absolutely pure sines in harmonic-stack intervals. Dry, no drift, no modulation. Digital clarity only.",
