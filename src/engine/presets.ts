...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    hint: "A subterranean organ mass: low pipes, almost no movement, and stone pressure instead of glow. Darker, heavier, and more buried than Kali Organ, with the nave felt as weight rather than space.",
    tuningId: "meantone", relationId: "drone-triad",
    voiceLayers: ["reed"],
    voiceLevels: { reed: 1 },
    reedShape: "balanced",
  ...
  },
  {
    ...
    hint: "The deteriorated SOTL: cassette-dubbed bowed strings through heavy wow flutter, much darker and more eroded than Nitrous Oxide. The cathedral is heard through tape hiss. Funereal, slow, dissolving.",
    tuningId: "just5", relationId: "minor-triad",
    voiceLayers: ["reed", "air"],
  ...
  },
  {
    ...
    hint: "A sustained sitar-drone atmosphere built from bright tanpura strings and a metallic shimmer layer evoking sympathetic taraf strings. Brighter and more articulate than the tanpura preset — jawari buzz plus upper-harmonic sparkle. Not a solo sitar, but the resonant glow of a sitar left ringing.",
    tuningId: "just5", relationId: "tonic-fifth",
  ...
  // ─── Nils Frahm — solo piano drone ──────────────────────────────────
  {
    ...
    hint: "Piano alone in a large reverberant room. No reed support — the piano resonance and hall tail carry everything. Sparse, spacious, intimate. The Budd/Frahm territory: single notes dissolving into space.",
    tuningId: "equal", relationId: "minor-triad",
    voiceLayers: ["piano"],
    voiceLevels: { piano: 1 },
  ...
  // ─── Marconi Union — clean modern ambient with slow descent ─────────
  {
    ...
    hint: "Clean high pads, sparse piano pings, and a gentle falling-bass sensation underneath. Wide, slow, and modern rather than nostalgic — spacious enough to float, deliberate enough not to blur.",
    tuningId: "just5", relationId: "drone-triad",
  ...
  },
  {
    ...
    hint: "The vocal/devotional side of maqam rast — reed (balanced) for richer organ-like harmonics, air for breath, formant for vocal resonance. More human and choral than the Oud preset, which is sharper and string-like.",
    voiceLayers: ["reed", "air"],
    voiceLevels: { reed: 1, air: 0.3 },
    reedShape: "balanced",
    octaveRange: [2, 3],
  ...
  // ─── Pauline Oliveros — accordion drone ────────────────────────────
  {
    ...
    hint: "The instrument in the room, close enough to hear the bellows. Fast breath, little room, no halo: just odd-harmonic reed tone and the feeling of an accordion moving air in front of you.",
    tuningId: "just5", relationId: "unison",
    voiceLayers: ["reed", "air"],
    voiceLevels: { reed: 1, air: 0.18 },
    reedShape: "odd",
  ...
  },
  {
    ...
    hint: "A single low fundamental driven by continuous breath cycles through a cylindrical-tube formant stack. Air for the breath body, odd-partial reed for vocal-tract overtones, sub for the thump. Slow ~6-second breath LFO modulates amplitude cyclically. Deep, bodily, continuous.",
    tuningId: "equal", relationId: "unison",
    voiceLayers: ["air", "reed"],
  ...
  },
  {
    ...
    hint: "Alva Noto / Ryoji Ikeda lineage: absolutely pure sine tones in harmonic-stack intervals, dry, zero drift, zero modulation. The precision IS the composition. No tape, no reverb, no warmth — digital clarity only.",
  ...
  },
  {
    ...
    hint: "Sunn O))) / Boris lineage: amp-cabinet body + odd-harmonic reed chord + metallic harmonic halo, held in minor triad through parallel cathedral reverb. Massive sub, long sustain, cranked tape saturation.",
    tuningId: "equal", relationId: "minor-triad",
    voiceLayers: ["amp", "reed", "metal"],
  ...
  },
  {
    ...
    hint: "Tuvan khöömei / Mongolian throat singing: balanced reed fundamental + high metal whistle partial emerging above. Different from Tibetan monastic chant — brighter, more melodic, with a prominent isolated overtone that feels separated from the fundamental.",
    tuningId: "equal", relationId: "tonic-fifth",
    voiceLayers: ["reed", "metal", "air"],
  ...
  },
  {
    ...
    hint: "Warm even-harmonic reed as ashram organ + piano strikes, in harmonic-stack intervals, under a shimmer ceiling and plate chamber. Alice Coltrane's devotional harp-organ records (Radha-Krsna Nama Sankirtana, Turiya Sings). Ecstatic but grounded.",
    tuningId: "harmonics", relationId: "harmonic-stack",
  ...
  },
  {
    ...
    hint: "Sarangi: bowed-string drone (odd-harmonic reed) against a tanpura tonic with a comb-resonant sympathetic-string halo. Vocal-like portamento glide, maqam-rast microtuning for the half-flat character. Warmer and more articulate than sitar-sympathy.",
    tuningId: "maqam-rast", relationId: "drone-triad",
