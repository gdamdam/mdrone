...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    name: "Kali Organ",
    attribution: "Dark pipe organ · meantone fourths · comb edge",
    hint: "Low pipe-organ reed with breath, dropped a register, tonic-fourth opening. Comb adds the metallic pipe edge that the previous Malone-style version lacked.",
    tuningId: "meantone", relationId: "tonic-fourth",
    voiceLayers: ["reed", "air"],
    voiceLevels: { reed: 0.92, air: 0.42 },
    reedShape: "balanced",
    octaveRange: [2, 2],   // dropped one register — sits below Dream House
    drift: 0.14,
    air: 0.55,
    time: 0.05,
    sub: 0.32,
    bloom: 0.7,
    glide: 0.55,     // very slow chord morphs
    lfoShape: "sine",
    lfoRate: 0.1,
    lfoAmount: 0.03, // organs don't tremolo
    climateX: 0.3,
    climateY: 0.16,
    effects: ["hall", "tape", "comb"],
    combFeedback: 0.4, // metallic pipe edge, controlled
    parallelSends: { hall: 0.3 },
    scale: "meantone",
    gain: 0.5,
    motionProfile: motionProfile({
      climateXRange: [0.22, 0.34],
      climateYRange: [0.1, 0.22],
      bloomRange: [0.62, 0.78],
      timeRange: [0.02, 0.08],
      driftRange: [0.1, 0.18],
      subRange: [0.24, 0.38],
      macroStep: 0.32,
  ...
  },
  {
    ...
    hint: "Pure sines in 5-limit just intonation. The beating between tones is the piece. Sits an octave above Kali Organ so the two never overlap.",
    tuningId: "just5", relationId: "drone-triad",
    voiceLayers: ["reed"],
    voiceLevels: { reed: 1 },
    reedShape: "sine",
    octaveRange: [3, 4],   // raised — keeps clear of Kali Organ at [2,2]
    drift: 0.05,
    air: 0.18,
    time: 0.03,
    sub: 0.14,
    bloom: 0.92,           // longer bloom — pure sines breathe slowly
    glide: 0.5,
    lfoShape: "sine",
    lfoRate: 0.05,
    lfoAmount: 0.02,
  ...
  },
  {
    ...
    name: "Devotional",
    attribution: "Tanpura ashram · Yaman raga · cistern space",
    hint: "Tanpura under reed organ and sparse piano strikes, Yaman raga, deep cistern space. Distinct from the harmonic-stack shimmer presets — this is the ashram itself.",
    tuningId: "custom:yaman", relationId: "drone-triad",
    voiceLayers: ["tanpura", "reed", "piano"],
    voiceLevels: { tanpura: 0.85, reed: 0.7, piano: 0.32 },
    reedShape: "even",
    octaveRange: [2, 3],
    drift: 0.12,
    air: 0.55,
...

  {
    ...
    name: "Surrender",
    attribution: "delta / 2 Hz FLICKER · bowl + breath in a cistern",
    hint: "Singing-bowl partials and breath, Pythagorean fifth, 2 Hz amplitude pulse. The pulse is the focus; the bowl voice keeps it distinct from the canonical tanpura presets.",
    voiceLayers: ["metal", "air"],
    voiceLevels: { metal: 0.9, air: 0.55 },
    octaveRange: [2, 2],
    drift: 0.08, air: 0.7, time: 0.12, sub: 0.05, bloom: 0.45, glide: 0.18,
    lfoShape: "sine", lfoRate: 0.12, lfoAmount: 0.15,
    climateX: 0.36, climateY: 0.22,
    effects: ["plate", "cistern"],
    scale: "drone",
    tuningId: "custom:pythagorean", relationId: "tonic-fifth",
    gain: 0.6,
    entrain: { enabled: true, rateHz: 2, mode: "am", dichoticCents: 8 },
    motionProfile: motionProfile({
      climateXRange: [0.32, 0.44], climateYRange: [0.16, 0.3],
      bloomRange: [0.38, 0.55], timeRange: [0.06, 0.16],
      driftRange: [0.05, 0.12], subRange: [0, 0.08],
      macroStep: 0.32, tonicWalk: "none", tonicIntervals: [],
  ...
  },
  {
    ...
    name: "Cistern Wind",
    attribution: "Meditative brown-noise wind in a deep cistern",
    hint: "Deep brown noise + air laid into a cistern. Wind through a stone room — contemplative, not industrial.",
