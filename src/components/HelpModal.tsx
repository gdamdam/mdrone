...
function ReferenceTab() {
  return (
    <>
      ...
      <ul className="help-list">
        <li><strong>DRONE</strong> — the instrument. Three tiers: <em>Performance</em> (always visible — preset / HOLD / tonic / WeatherPad / macros), <em>EDIT</em> (one tap — INSTRUMENTS toggles, per-voice levels, FX BAR), <em>ADVANCED</em> (one tap — tuning, LFO, fine-detune, entrain).</li>
